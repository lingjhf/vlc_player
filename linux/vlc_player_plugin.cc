...
static void vlc_player_plugin_handle_method_call(
    VlcPlayerPlugin* self,
...
void vlc_player_plugin_register_with_registrar(FlPluginRegistrar* registrar) {
  VlcPlayerPlugin* plugin = VLC_PLAYER_PLUGIN(
      g_object_new(vlc_player_plugin_get_type(), nullptr));
